...
class TestUtils(unittest.TestCase):
	...
	def test_generate(self):
		...
		self.assertIs(os.path.isfile(os.path.join(out_dir, 'themes/071e83fca9e212ba9233-colors.sh')), True)
		self.assertIs(os.path.isfile(os.path.join(out_dir, 'themes/071e83fca9e212ba9233-Xdefaults')), True)
	...
	def test_update(self):
		...
		self.assertIs(os.readlink(os.path.join(out_dir, 'colors.sh')) ==\
			os.path.join(out_dir, 'themes/071e83fca9e212ba9233-colors.sh'), True)
		self.assertEqual(os.readlink(os.path.join(out_dir, 'Xdefaults')),
			os.path.join(out_dir, 'themes/071e83fca9e212ba9233-Xdefaults'))
